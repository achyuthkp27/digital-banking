...
export function Button({
  ...
  if (isGlass) {
    baseClass +=
      'bg-[var(--glass-bg-start)] border border-[var(--glass-border)] backdrop-blur-xl text-[var(--text-primary)] shadow-[0_10px_30px_var(--glass-shadow-drop)] hover:bg-[var(--glass-bg-end)] hover:border-[var(--glass-border-hover)] ';
  } else if (variant === 'contained') {
    baseClass +=
      'bg-accent text-black shadow-[0_4px_14px_0_rgba(16,185,129,0.39)] hover:brightness-110 hover:-translate-y-px hover:scale-[1.02] hover:shadow-[0_6px_20px_rgba(16,185,129,0.5)] ';
