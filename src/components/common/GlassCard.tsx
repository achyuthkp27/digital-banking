...
export default function GlassCard({
  ...
  if (hover) {
    baseClass +=
      'hover:-translate-y-1 hover:border-[var(--glass-border-hover)] hover:shadow-[inset_0_1px_1px_var(--glass-shadow-inner-hover),0_16px_40px_-10px_var(--glass-shadow-drop-hover)] ';
  }
