              ...
              <StaggerItem key={stat.label}>
                <GlassCard hover className="p-6 md:p-8 text-center relative overflow-hidden">
                  <div className="relative z-10">
                    <h3 className="text-[2.5rem] md:text-[3rem] font-extrabold tracking-[-0.03em] text-[var(--text-primary)] leading-none mb-2">
                      {stat.prefix || ''}
                      <AnimatedCounter value={stat.value} duration={2.5} decimals={stat.decimals} />
                      {stat.suffix}
                    </h3>
