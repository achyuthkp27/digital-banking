...
export default function HeroAppAnimation() {
  ...
  useEffect(() => {
    ...
    if (step === 5) timer = setTimeout(() => setStep(1), 4000);
    ...
    >
      <motion.div
        ...
        style={{
          ...
          borderRadius: '16px',
          boxShadow:
            '-30px 30px 100px var(--glass-shadow-drop), inset 0 1px 1px var(--glass-shadow-inner)',
          position: 'relative',
          overflow: 'hidden',
          display: 'flex',
                          ...
                          return (
                            <motion.div
                              ...
                              style={{
                                ...
                                flexDirection: 'column',
                                justifyContent: 'space-between',
                                boxShadow: '0 10px 20px var(--glass-shadow-drop)',
