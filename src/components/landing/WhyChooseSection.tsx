...
const statKeys = [
  {
    ...
    prefix: '< ',
    suffix: 'ms',
    labelKey: 'globalSettlement' as const,
  ...
  },
  {
    ...
    value: 99.999,
    suffix: '%',
    labelKey: 'platformAvailability' as const,
  ...
  },
  {
    ...
    value: 10,
    suffix: 'M+',
    labelKey: 'eventsProcessed' as const,
    format: (v: number) => Math.round(v).toString(),
  },
  {
    id: '04',
    value: 256,
    suffix: '-bit',
    labelKey: 'e2eEncryption' as const,
    format: (v: number) => Math.round(v).toString(),
  },
  {
    id: '05',
        ...
        >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  width: '1px',
                  background:
                    'linear-gradient(180deg, transparent 0%, var(--accent) 40%, var(--accent) 60%, transparent 100%)',
                  opacity: 0.09,
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                'repeating-linear-gradient(90deg, transparent 0%, rgba(var(--accent-rgb),0.2) 2%, transparent 4%)',
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                'repeating-linear-gradient(180deg, transparent 0%, rgba(var(--accent-rgb),0.15) 2%, transparent 4%)',
