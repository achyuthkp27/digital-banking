...
export default function ProductHero({ title, subtitle, slug }: ProductHeroProps) {
  return (
    ...
    >
      {/* Ambient glows */}
      <div style={{
        position: 'absolute', top: '30%', left: '20%', width: '600px', height: '600px',
      ...
      <div style={{
        ...
        gap: 'clamp(32px, 5vw, 80px)', minHeight: '100vh',
      }}>
        {/* LEFT: Text */}
        <div style={{ flex: '1 1 50%', display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          <Link href="/#products" style={{
            ...
            textDecoration: 'none', marginBottom: '32px', letterSpacing: '0.04em',
            textTransform: 'uppercase', fontFamily: 'var(--font-geist-mono), monospace',
          ...
          <h1 style={{
            ...
            fontFamily: 'var(--font-syne), sans-serif', marginBottom: '24px',
          }}>
            {title}
          </h1>
          ...
          <div style={{
            ...
            marginBottom: '24px', boxShadow: '0 0 16px rgba(16,185,129,0.4)',
          }} />
          ...
          <div style={{ display: 'flex', gap: '14px', flexWrap: 'wrap' }}>
            <Link href="https://dev.fisdbs.com/OLBRETAIL/" target="_blank" rel="noopener noreferrer" style={{
              display: 'inline-flex', alignItems: 'center', gap: '10px',
              padding: '16px 40px', borderRadius: '9999px', background: '#ffffff',
              color: '#000000', fontSize: '15px', fontWeight: 600, textDecoration: 'none',
            ...
            <Link href="/#products" style={{
              ...
              borderRadius: '9999px', background: 'transparent', color: 'var(--text-primary)',
              fontSize: '15px', fontWeight: 500, textDecoration: 'none',
              border: '1px solid rgba(255,255,255,0.12)',
              transition: 'border-color 0.25s ease, background 0.25s ease', cursor: 'pointer',
            }}>
              View All Products
            </Link>
          </div>
        ...
        <div style={{
          ...
          height: 'clamp(400px, 50vh, 600px)', minWidth: '300px',
          ...
          {[
            ...
            <div key={i} style={{
              ...
              borderRadius: c.br, pointerEvents: 'none', zIndex: 2,
            }} />
          ))}
        </div>
      </div>
      ...
      <div style={{
        ...
        zIndex: 20, pointerEvents: 'none', opacity: 0.4, mixBlendMode: 'screen' as const,
      }} />
