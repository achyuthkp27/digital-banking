      ...
      >
        <motion.div
          style={{
            ...
            borderRadius: '16px',
            boxShadow: '0 40px 100px var(--glass-shadow-drop), 0 0 0 1px var(--glass-border) inset',
            aspectRatio: '16/9',
            position: 'relative',
            overflow: 'hidden',
          }}
        >
          ...
          {}
          <div
            style={{ padding: '32px', display: 'flex', gap: '32px', height: 'calc(100% - 48px)' }}
          >
            {}
            <div
              style={{ flex: '0 0 200px', display: 'flex', flexDirection: 'column', gap: '16px' }}
            >
              {[
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        ...
                        alignItems: 'center',
                        borderBottom:
                          i === 3 ? 'none' : '1px solid rgba(var(--color-invert-rgb), 0.05)',
                        paddingBottom: i === 3 ? 0 : '16px',
                      }}
                    >
                        ...
                        >
                          <div
                            style={{
                              ...
                              height: 8,
                              borderRadius: '50%',
                              background: tx.amount.startsWith('+') ? 'var(--accent)' : '#ef4444',
                            }}
                          />
                        </div>
                        <div>
                      ...
                      <div style={{ textAlign: 'right' }}>
                        ...
                        <div
                          style={{
                            fontFamily: 'var(--font-geist-mono), monospace',
                            fontSize: '11px',
                            color: tx.status === 'Settled' ? 'var(--accent)' : '#f59e0b',
                          }}
                        >
                          {tx.status}
                        </div>
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                'linear-gradient(135deg, rgba(var(--color-invert-rgb), 0.05) 0%, transparent 40%)',
              pointerEvents: 'none',
            }}
          />
        </motion.div>
