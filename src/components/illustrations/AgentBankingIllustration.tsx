    ...
    <div style={{ width: '100%', height: '100%', minHeight: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          <div style={{ display: 'flex', gap: '3px' }}>
            {[8, 10, 12, 14].map((h, i) => (
              <div key={i} style={{ width: '3px', height: `${h}px`, borderRadius: '1px', background: `rgba(var(--accent-rgb),${0.3 + i * 0.15})` }} />
            ))}
          </div>
          {/* Sync icon */}
          <div style={{ animation: 'agent-sync 3s linear infinite' }}>
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="rgba(var(--accent-rgb),0.5)" strokeWidth="1.5">
        ...
        {formFields.map((field, i) => (
          ...
          >
            <div style={{
              fontSize: '7px', color: 'rgba(var(--accent-rgb),0.4)',
            ...
            <div style={{
              ...
              borderRadius: '2px', background: 'rgba(var(--accent-rgb),0.2)',
            }} />
          </motion.div>
        ))}
        ...
        <motion.div
          ...
          style={{
            ...
            borderRadius: '6px', background: 'rgba(var(--accent-rgb),0.15)',
            border: '1px solid rgba(var(--accent-rgb),0.3)',
            textAlign: 'center',
          }}
        >
          <span style={{ fontSize: '8px', fontWeight: 600, color: 'var(--accent)', fontFamily: 'var(--font-geist-mono), monospace', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            Submit
          </span>
        </motion.div>
      </motion.div>
      ...
      >
        <svg width="28" height="36" viewBox="0 0 24 32" fill="none">
          <path d="M12 0C5.4 0 0 5.4 0 12c0 9 12 20 12 20s12-11 12-20C24 5.4 18.6 0 12 0z" fill="rgba(var(--accent-rgb),0.2)" stroke="var(--accent)" strokeWidth="1.5" />
          <circle cx="12" cy="12" r="4" fill="var(--accent)" opacity="0.6" />
        </svg>
