            ...
            {[6, 8, 10, 12].map((h, i) => (
              <div
                ...
                style={{
                  ...
                  height: `${h}px`,
                  borderRadius: '1px',
                  background: `rgba(var(--accent-rgb),${0.2 + i * 0.1})`,
                }}
              />
            ))}
          </div>
        ...
        <div style={{ padding: '8px 12px', flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <motion.div
            ...
            style={{
              ...
              marginBottom: '10px',
              background:
                'linear-gradient(135deg, rgba(var(--accent-rgb),0.12), rgba(6,182,212,0.08))',
          ...
          >
            <div style={{ animation: 'mob-fp 2s ease-in-out infinite' }}>
              ...
              >
                <path
                  d="M12 2a10 10 0 0110 10M12 6a6 6 0 016 6M12 10a2 2 0 012 2v4M8 12a4 4 0 014-4M4 12a8 8 0 018-8"
                  strokeLinecap="round"
                />
              </svg>
            </div>
          ...
          {txns.map((tx, i) => (
            <motion.div
              ...
              style={{
                ...
                padding: '6px 0',
                borderBottom:
                  i < txns.length - 1 ? '1px solid rgba(var(--accent-rgb),0.06)' : 'none',
              }}
            >
              <span
                style={{
