...
export default function AppFlowAnimation() {
  ...
  const cards = [
    ...
    },
    {
      ...
      border: 'rgba(var(--color-invert-rgb), 0.6)',
      color: '#000',
    },
    {
      type: 'REWARDS',
      ...
      border: 'rgba(var(--color-invert-rgb), 0.3)',
      color: '#fff',
    },
  ];
    ...
    >
      <div
        style={{
          ...
          height: '1200px',
          background:
            'radial-gradient(circle, rgba(var(--accent-rgb), 0.08) 0%, rgba(3, 7, 18, 0) 60%)',
          pointerEvents: 'none',
          zIndex: 0,
        }}
      />
              ...
              >
                ...
                >
                  <div style={{ textAlign: 'center', marginBottom: '8px' }}>
                    ...
                    >
                      Enter your credentials to securely access your enterprise dashboard.
                    </p>
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          height: '16px',
                          background: 'rgba(var(--color-invert-rgb), 0.8)',
                          borderRadius: '4px',
                          maxWidth: '60%',
                        }}
                      />
                    ...
                    {step === 3 ? (
                      <motion.div
                        ...
                        style={{
                          width: '24px',
                          height: '24px',
                          border: '3px solid rgba(var(--color-base-rgb), 0.1)',
                          borderTopColor: '#000',
                          borderRadius: '50%',
                        }}
                      />
                ...
                >
                  <div
                    style={{
                      ...
                      width: '140px',
                      background:
                        'linear-gradient(90deg, rgba(var(--color-invert-rgb), 0.2), rgba(var(--color-invert-rgb), 0.05))',
                      borderRadius: '6px',
                      marginBottom: '40px',
                    }}
                  />
                  {['Overview', 'Transactions', 'Cards & Limits', 'Analytics', 'Settings'].map(
                    (label, i) => (
                      <motion.div
                        key={i}
                      ...
                      >
                        <span
                          style={{
                            color: i === 0 ? 'var(--accent)' : 'rgba(var(--color-invert-rgb), 0.5)',
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      ...
                      <div>
                        ...
                        <div
                          style={{ color: 'rgba(var(--color-invert-rgb), 0.5)', fontSize: '12px' }}
                        >
                          Enterprise Admin
                        </div>
                      </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Track your enterprise cash flow and active cards.
                      </p>
                    </motion.div>
                    <motion.div
                              ...
                              style={{
                                ...
                                background:
                                  stat.trend === 'up'
                                    ...
                                    : stat.trend === 'down'
                                      ? 'rgba(239,68,68,0.1)'
                                      : 'rgba(var(--color-invert-rgb), 0.05)',
                                borderRadius: '4px',
                              }}
                            >
                              {stat.change}
                  ...
                  <div style={{ display: 'flex', gap: '24px', flex: 1, minHeight: '340px' }}>
                    ...
                    >
                            ...
                            <div
                              ...
                              style={{
                                ...
                                color:
                                  idx === 1
                                    ? 'var(--bg-base)'
                                    : 'rgba(var(--color-invert-rgb), 0.6)',
                                background: idx === 1 ? 'var(--text-primary)' : 'transparent',
                                borderRadius: '4px',
                      ...
                      >
                        ...
                        >
                          {[100, 75, 50, 25, 0].map((val) => (
                            <div
                              key={val}
                              style={{
                                borderBottom: '1px dashed rgba(var(--color-invert-rgb), 0.05)',
                                display: 'flex',
                                alignItems: 'flex-end',
                                paddingBottom: '4px',
                              }}
                            >
                              <span
                                style={{
                                  color: 'rgba(var(--color-invert-rgb), 0.3)',
                                  fontSize: '10px',
                                }}
                              >
                                {val}k
                        ...
                        {step >= 5 &&
                          [40, 65, 30, 85, 50, 95, 75, 45, 60, 80].map((h, i) => (
                            <motion.div
                              key={i}
                              ...
                              style={{
                                flex: 1,
                                background:
                                  'linear-gradient(to top, rgba(var(--accent-rgb),0.8), rgba(var(--accent-rgb),0.1))',
                        ...
                        {step >= 5 && (
                          ...
                          >
                            <motion.path
                              ...
                              style={{
                                filter:
                                  'drop-shadow(0 8px 12px rgba(var(--color-invert-rgb), 0.4))',
                              }}
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          style={{ position: 'relative', height: '160px', perspective: '1000px' }}
                        >
                          <AnimatePresence>
                            {step >= 5 &&
                              cards.map((card, i) => {
                                ...
                                return (
                                  <motion.div
                                    ...
                                    style={{
                                      ...
                                      padding: '20px',
                                      boxShadow: isFront
                                        ? '0 20px 40px var(--glass-shadow-drop)'
                                        : 'none',
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <svg width="24" height="16" viewBox="0 0 32 24" fill="none">
                                        ...
                                        <path
                                          d="M4 12H28"
                                          stroke={card.color ? 'var(--text-primary)' : '#000'}
                                          strokeWidth="2"
                                        />
                                      </svg>
                                    </div>
                            ...
                            [
                              ...
                              <motion.div
                                ...
                                style={{
                                  ...
                                  background: 'rgba(var(--color-invert-rgb), 0.02)',
                                  borderRadius: '12px',
                                  border: '1px solid rgba(var(--color-invert-rgb), 0.03)',
                                }}
                              >
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                  <div
